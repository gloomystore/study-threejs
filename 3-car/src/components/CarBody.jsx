...
Command: npx gltfjsx@6.2.16 ./public/assets/models/car_taxi.glb --o CarBody.jsx 
*/

import React, { useRef } from 'react'

export default function CarBody({nodes, materials}) {
  return (
    <group rotation={[0, Math.PI,0]} scale={[0.33, 0.32, 0.46]} position={[0,-0.06,-0.02]} dispose={null}>{/* dispose true로 해주면 이 모델이 안보일때 메모리에서 해제해버림. 재사용 잘 안할때 쓰면 됨 */}
